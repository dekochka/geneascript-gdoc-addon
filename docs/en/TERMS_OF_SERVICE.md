...
IN NO EVENT SHALL THE DEVELOPER BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF DATA, PROFITS, OR REVENUE, ARISING OUT OF OR RELATED TO YOUR USE OF THE ADD-ON, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
...
The developer may update these Terms at any time by posting a revised version in this repository. Continued use of the Add-on after changes constitutes acceptance of the updated Terms.

## 9. Open Source

The Add-on source code is available at [github.com/dekochka/geneascript-gdoc-addon](https://github.com/dekochka/geneascript-gdoc-addon). You are free to review, fork, and modify the code in accordance with the repository's license.

## 10. Termination

You may stop using the Add-on and uninstall it at any time. The developer reserves the right to discontinue the Add-on at any time without notice.
